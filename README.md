...
7. (Wochenende_plot only). Install the python dependencies for visualization by pip. 

On Ubuntu 2004: `python -m pip install --user numpy==1.20.2 numpy-base==1.20.2 pandas==1.2.5 matplotlib==3.3.4`
